export const menu = [
  {
    name: "Campus",
    icon: "campus",
    description: "A unique, exclusive space for college students on Together.",
  },
  {
    name: "Events",
    icon: "events",
  ...
  },
  {
    name: "Pages",
    icon: "pages",
    description: "Discover and connect with businesses on Together.",
  },
  {
    name: "Gaming Video",
    icon: "gaming",
  ...
  },
  {
    ...
    icon: "recent",
    description: "See all the ads you interacted with on Together.",
  },
  {
    name: "Memories",
    icon: "memories",
    description: "Browse your old photos, videos and posts on Together.",
  },
  {
    name: "Saved",
    icon: "saved",
