  ...
  return (
    <div className="absolute_wrap">
      ...
      <div className="mmenu_main">
        <div className="small_circle hover1 " style={{width:"50px"}}>
          <i className="dark_filled_icon"></i>
        </div>
        <div className="mmenu_col">
          <span className="mmenu_span1">Dark Mode</span>
          <span className="mmenu_span2">
            Adjust the appearance of Together to reduce glare and give your eyes
            a break
          </span>
        </div>
      </div>
      ...
      <div className="mmenu_main">
        ...
        <div className="mmenu_col">
          ...
          <span className="mmenu_span2">
            Make your font size smaller to more content can fit on the screen.
          </span>
        </div>
      </div>
